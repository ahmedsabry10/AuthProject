...
import 'package:test_auth/Data/Models/user_model.dart';
import 'package:test_auth/Screens/AuthScreens/FaceTest/page/face_recognition/ml_service.dart';
import 'package:test_auth/Screens/AuthScreens/FaceTest/widgets/common_widgets.dart';
import 'package:test_auth/Screens/AuthScreens/FingerPrint/FingerPage.dart';
      ...
      if (widget.user == null) {
        ...
        if (user == null) {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const FingerAuth()));
        }
      }
    }
    if (mounted) setState(() {});
